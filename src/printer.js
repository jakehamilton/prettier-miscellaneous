...
function getPropertyPadding (options, path) {
    ...
    const isPropertyKey =
        (parentNode.type === 'Property' || parentNode.type === 'ObjectProperty') && parentNode.key === n;
    ...
    switch (n.type) {
        ...
        case 'LogicalExpression': {
            ...
            if (
                ...
                (parent.type === 'JSXExpressionContainer' && parentParent.type === 'JSXAttribute') ||
        ...
        case 'ArrowFunctionExpression': {
            ...
            const shouldAddParens =
                ...
                !util.startsWithNoLookaheadToken(n.body, /* forbidFunctionAndClass */ false);
        ...
        case 'ImportDeclaration': {
            ...
            if (n.specifiers && n.specifiers.length > 0) {
                ...
                // import {} from 'x'
                /{\s*}/.test(options.originalText.slice(util.locStart(n), util.locStart(n.source)))
            ) {
                parts.push('{} from ');
            }
        ...
        case 'CallExpression': {
            ...
            if (
                ...
                (!isNew &&
                    ...
                    (n.callee.name === 'it' || n.callee.name === 'test' || n.callee.name === 'describe') &&
        ...
        case 'TSTypeLiteral': {
            ...
            const shouldBreak =
                ...
                (n.type !== 'ObjectPattern' &&
                    util.hasNewlineInRange(options.originalText, util.locStart(n), util.locEnd(n)));
            const separator = n.type === 'TSInterfaceBody' || n.type === 'TSTypeLiteral' ? ifBreak(semi, ';') : ',';
            const fields = [];
            ...
            if (props.length === 0 && !n.typeAnnotation) {
                ...
                content = concat([
                    ...
                    ifBreak(
                        canHaveTrailingSeparator && (separator !== ',' || shouldPrintComma(options, 'object'))
                            ? separator
                            : '',
                    ),
                    concat([
            ...
            if (
                (n.type === 'ObjectPattern' && parent && shouldHugArguments(parent) && parent.params[0] === n) ||
                (shouldHugType(n) &&
                    parentParentParent &&
        ...
        case 'Property':
            ...
            if (n.shorthand) {
                ...
                parts.push(
                    printAssignment(n.key, printedLeft, ':', n.value, path.call(print, 'value'), options, n.type),
                );
            }
        ...
        case 'ArrayPattern':
            if (n.elements.length === 0) {
                ...
                path.each((childPath) => {
                    ...
                    separatorParts = [
                        ',',
                        options.arrayExpand ? hardline : line,
                    ];
                    if (childPath.getValue() && util.isNextLineEmpty(options.originalText, childPath.getValue())) {
                ...
                parts.push(
                    group(
                        concat([
                            ...
                            ifBreak(
                                canHaveTrailingComma && !needsForcedTrailingComma && shouldPrintComma(options, 'array')
                                    ? ','
                                    : '',
                            ),
                            comments.printDanglingComments(path, options, /* sameIndent */ true),
                            options.arrayExpand ? hardline : options.bracketSpacing ? line : softline,
                            ']',
                        ]),
                    ),
                );
        ...
        case 'ConditionalExpression': {
            ...
            if (
                ...
                parts.push(
                    ' ? ',
                    shouldNotWrap(n.consequent) ? path.call(print, 'consequent') : wrap(path.call(print, 'consequent')),
                    ' : ',
                    shouldNotWrap(n.alternate) ? path.call(print, 'alternate') : wrap(path.call(print, 'alternate')),
                );
            } else {
                // normal mode
                parts.push(
            ...
            const maybeGroup = (doc) =>
                jsxMode ? (parent === firstNonConditionalParent ? group(doc) : doc) : group(doc); // Always group in normal mode.
        ...
        case 'IfStatement': {
            ...
            if (n.alternate) {
                ...
                parts.push(
                    group(adjustClause(n.alternate, path.call(print, 'alternate'), n.alternate.type === 'IfStatement')),
                );
            }
        ...
        case 'ForStatement': {
            ...
            const printedComments = dangling
                ? concat([
                      dangling,
                      softline,
                  ])
        ...
        case 'JSXEmptyExpression': {
            ...
            return concat([
                comments.printDanglingComments(path, options, /* sameIndent */ !requiresHardline),
        ...
        case 'TupleTypeAnnotation': {
            ...
            return group(
                concat([
                    ...
                    n.type === 'TSTupleType' ? '' : ifBreak(shouldPrintComma(options, 'array') ? ',' : ''),
                    comments.printDanglingComments(path, options, /* sameIndent */ true),
                    softline,
                    ']',
                ]),
        ...
        case 'TSFunctionType': {
            ...
            parts.push(printFunctionParams(path, print, options, /* expandArg */ false, /* printTypeParams */ true));
        ...
        case 'UnionTypeAnnotation': {
            ...
            const shouldIndent =
                ...
                !(
                    (parent.type === 'TypeAlias' || parent.type === 'VariableDeclarator') &&
        ...
        case 'TSCallSignature': {
            ...
            parts.push(
                group(printFunctionParams(path, print, options, /* expandArg */ false, /* printTypeParams */ true)),
            );
        ...
        case 'TSMethodSignature':
            parts.push(
                ...
                n.computed ? ']' : '',
                n.optional ? '?' : '',
                printFunctionParams(path, print, options, /* expandArg */ false, /* printTypeParams */ true),
            );
        ...
        case 'TSModuleDeclaration': {
            ...
            if (parentIsDeclaration) {
                ...
                const isGlobalDeclaration =
                    ...
                    n.name.name === 'global' &&
                    !/namespace|module/.test(options.originalText.slice(util.locStart(n), util.locStart(n.name)));
            ...
            if (bodyIsDeclaration) {
                ...
                parts.push(
                    ...
                    indent(
                        concat([
                            line,
                            path.call((bodyPath) => comments.printDanglingComments(bodyPath, options, true), 'body'),
...
function shouldGroupFirstArg (args) {
    ...
    return (
        ...
        (firstArg.type === 'FunctionExpression' ||
            (firstArg.type === 'ArrowFunctionExpression' && firstArg.body.type === 'BlockStatement')) &&
...
function printFunctionParams (path, print, options, expandArg, printTypeParams) {
    ...
    const isFlowShorthandWithOneArg =
        (isObjectTypePropertyAFunction(parent) ||
            ...
            (parent.type === 'FunctionTypeAnnotation' && parent.returnType === fun)) &&
    ...
    return concat([
        ...
        ifBreak(canHaveTrailingComma && shouldPrintComma(options, 'arguments') ? ',' : ''),
        softline,
        ')',
    ]);
}
    ...
    if (decl.declaration) {
        ...
        if (decl.specifiers && decl.specifiers.length > 0) {
            ...
            const isNamespaceFollowed =
                namespaceSpecifiers.length !== 0 && (specifiers.length !== 0 || defaultSpecifiers.length !== 0);
...
function printTypeParameters (path, options, print, paramsKey) {
    ...
    const shouldInline =
        ...
        (shouldHugType(n[paramsKey][0]) ||
            (n[paramsKey][0].type === 'GenericTypeAnnotation' && shouldHugType(n[paramsKey][0].id)) ||
    ...
    return group(
        concat([
            ...
            ifBreak(options.parser !== 'typescript' && shouldPrintComma(options, 'arguments') ? ',' : ''),
            softline,
            '>',
        ]),
    );
...
function printMemberChain (path, options, print) {
    ...
    const shouldMerge =
        ...
        (groups[0][0].node.type === 'ThisExpression' ||
            (groups[0][0].node.type === 'Identifier' && groups[0][0].node.name.match(/(^[A-Z])|^[_$]+$/)));
...
function printJSXElement (path, options, print) {
    ...
    const containsMultipleExpressions =
        n.children.filter((child) => child.type === 'JSXExpressionContainer').length > 1;
    const containsMultipleAttributes = n.openingElement.attributes.length > 1;

    // Record any breaks. Should never go from true to false, only false to true.
    let forcedBreak =
        willBreak(openingLines) || containsTag || containsMultipleAttributes || containsMultipleExpressions;
    ...
    while (children.length && (isLineNext(util.getLast(children)) || isEmpty(util.getLast(children)))) {
        children.pop();
    }
    ...
    const content = containsText ? fill(multilineChildren) : group(concat(multilineChildren), { shouldBreak: true });
...
function printBinaryishExpressions (path, print, options, isNested, isInsideParenthesis) {
    ...
    if (isBinaryish(node)) {
        ...
        if (util.shouldFlatten(node.operator, node.left.operator)) {
            ...
            parts = parts.concat(
                path.call(
                    (left) => printBinaryishExpressions(left, print, options, /* isNested */ true, isInsideParenthesis),
                    'left',
                ),
            );
        } else {
...
function printAssignment (leftNode, printedLeft, operator, rightNode, printedRight, options, type) {
    ...
    const canBreak =
        ...
        ((leftNode.type === 'Identifier' || isStringLiteral(leftNode) || leftNode.type === 'MemberExpression') &&
...
function nodeStr (node, options, isFlowOrTypeScriptDirectiveLiteral) {
    ...
    const enclosingQuote =
        options.parser === 'json' ? double.quote : shouldUseAlternateQuote ? alternate.quote : preferred.quote;
...
function hasLeadingOwnLineComment (text, node) {
    ...
    const res =
        node.comments &&
        node.comments.some((comment) => comment.leading && util.hasNewline(text, util.locEnd(comment)));
    return res;
}
...
function exprNeedsASIProtection (node, options) {
    ...
    const maybeASIProblem =
        ...
        (node.type === 'ArrowFunctionExpression' && !canPrintParamsWithoutParens(node, options)) ||
        node.type === 'ArrayExpression' ||
        node.type === 'ArrayPattern' ||
        (node.type === 'UnaryExpression' && node.prefix && (node.operator === '+' || node.operator === '-')) ||
...
function isNodeStartingWithDeclare (node, options) {
    ...
    return (
        ...
        options.originalText.slice(node.range[0], node.range[1]).startsWith('declare ')
    );
}
...
function shouldHugArguments (fun) {
    return (
        ...
        (fun.params[0].type === 'ObjectPattern' ||
            ...
            (fun.params[0].type === 'FunctionTypeParam' && isObjectType(fun.params[0].typeAnnotation))) &&
        !fun.rest
    );
}
...
function printAstToDoc (ast, options, addAlignmentSize) {
    ...
    function printGenerically (path, args) {
        ...
        if (
            ...
            (parent && (parent.type === 'UnionTypeAnnotation' || parent.type === 'TSUnionType'))
        ) {
